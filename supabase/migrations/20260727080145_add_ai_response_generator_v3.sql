/*
# AI Assistant Response Generator (Database-side)

Generates contextual AI responses directly in the database.
*/
...
What can I help you discover? 🚀'
  ...
  RETURNING to_jsonb(t.*) INTO v_inserted;
